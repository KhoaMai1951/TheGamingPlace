		...
		<div class="col-md-4" style="padding-left: 20px;">
			<div class="cart-block" style="border-color: aqua;">
  			...
  			<div class="list-group" style="padding-top: 30px;">
  				...
  				<a href="product_xbox.php" class="list-group-item list-group-item-action active">Xbox</a>
		...
		<form method='post'>
			<div class="card">
				<div class="card-header" style="background:#008C33;">
					<div class="card-title" style="color:white; font-size: 25px;"><strong>XBox Games </strong></div>
				</div>
