			...
			<div class="cart-block" style=" background-color: darkgrey;">
                        ...
                        ?>
                        		<tr style="border-bottom: 1px solid darkgrey;">
									...
									<th style="border-bottom: 1px solid darkgrey; color: black;"><?php echo number_format($total,2). " $"; ?>
									</th>
									<th style="border-bottom: 1px solid darkgrey; color: black;"></th>
                            		</th>                           		
                        		</tr>
					...
					<a class="btn btn-dark" href="checkout_test.php">Go To Cart</a>
		...
		<div class="col-md-8">
            ...
            if(mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                    <div class="col-md-4">
                        <form method="post" action="index_2.php?action=add&id=<?php echo $row["id"]; ?>" style="padding-top: 20px;">
                            <div class="product">
